  ...
  useEffect(() => {
    if (user) {
      ...
      const initialEmergency = {
        bloodGroup: userAny.emergency?.bloodGroup || 'O+',
        medicalConditions: userAny.emergency?.medicalConditions || 'None',
        specialAssistance: userAny.emergency?.specialAssistance || false,
      };
      ...
      const initialSecurity = {
        ...
        confirmPassword: '',
        twoFAEnabled: false,
        lastLogin: formatLastLogin(userAny.lastLogin, userAny.address?.city, userAny.address?.state),
      };
        ...
        <main className="flex-1 overflow-y-auto p-7">
          ...
          {activeTab === 'personal' && (
            <div className="max-w-xl transition-all duration-300">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Field label="Role" icon={BadgeCheck} value={personal.role} readOnly />
                {!isEditing('personal') ? (
          ...
          {activeTab === 'emergency' && (
            <div className="max-w-xl transition-all duration-300">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Field label="Full Name" icon={User} value={personal.name} readOnly />
                <Field label="Mobile Number" icon={Phone} value={personal.mobile} readOnly />
...
export default function Profile() {
  return (
    <Suspense fallback={<div className="flex h-screen items-center justify-center text-sm font-semibold">Loading Profile...</div>}>
      <ProfileContent />
    </Suspense>
  );
}
