 ...
 *   5. Render <ReportButton> as a fixed floating button on every page.
 *   6. Set document-level metadata (title, description).
 *
 ...
 *         <Navbar />
 *         <main>{children}</main>
 *         <ReportButton /> {/* fixed floating — bottom-right on every page *\/}
 *       </Providers>
 *     </body>
 *   </html>
 */
